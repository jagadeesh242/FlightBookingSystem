...
public class FlightBookingApp {
	...
	public static void main(String[] args) {
		...
		Admin admin = new Admin("Jacky");
		
		ArrayList<Passenger> passengers = new ArrayList<>(); 
		ArrayList<Flight> flights = new ArrayList<>();
		ArrayList<Booking> bookings = new ArrayList<>();
		
		flights.add(new Flight("AI101", "Chennai", "Nepal", 6000));
		flights.add(new Flight("Ek505", "Salem", "Thailand", 10000));
		flights.add(new Flight("AK007", "Coimbatore", "America", 20000));
		flights.add(new Flight("VK018", "Namakkal", "Korea", 30000));
		...
		while(true) {
			...
			case 3:
				if(passengers.isEmpty()) {
					System.out.println("Registerr a Passenger Frist...");
					break;
				}
				...
				bookings.add(new Booking(selectedPssenger, flights.get(fid-1), date));
			...
			default:
				System.out.println("Knvalid choice");
			}
		}
